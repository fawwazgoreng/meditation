...
| --------- | -------- | -------- | ---------------------------------------------------------------- |
| `user`    | `string` | ✅ Yes   | GitHub username to fetch data from.                              |
| `theme`   | `string` | ❌ No    | Visual color palette (see [Available Themes](#available-themes)) |

### **Example Requests**

```bash
# Top languages with winter theme
curl "[https://meditation-cyan.vercel.app/stats?user=fawwazgoreng&theme=winter](https://meditation-cyan.vercel.app/stats?user=fawwazgoreng&theme=winter)"

![stat image](assets/stats.png)


# Contribution streak with winter theme
curl "[https://meditation-cyan.vercel.app/streak?user=fawwazgoreng&theme=winter](https://meditation-cyan.vercel.app/streak?user=fawwazgoreng&theme=winter)"

![streak image](assets/streak.png)

# Stats card with winter theme
curl "[https://meditation-cyan.vercel.app/card?user=fawwazgoreng&theme=winter](https://meditation-cyan.vercel.app/card?user=fawwazgoreng&theme=winter)"

![card image](assets/card.png)

# Activity graph with winter theme
curl "[https://meditation-cyan.vercel.app/activity?user=fawwazgoreng&theme=winter](https://meditation-cyan.vercel.app/activity?user=fawwazgoreng&theme=winter)"

![activity image](assets/activity.png)
